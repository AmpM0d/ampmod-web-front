<script lang="ts">
  ...
  function handleJoin(): void {
    ...
    showMessageBox('Account created successfully (mock)!');
...
<div
  class="max-w-xl mx-auto mt-16 p-8 border border-gray-300 dark:border-border-dark rounded-lg font-sans bg-background dark:bg-background-dark text-text dark:text-text-dark shadow-lg"
>
